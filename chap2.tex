...
Both devices have different aims and capabilities. Arduino is a easy-to-use lower-level physical computing platform, whereas Raspberry Pi beats general purpose PCs in terms of cost and size. Nonetheless, it is not unusual to combine their features attaching them together as a single device, which \cite and \cite already attempted. While Arduino brings sensing capabilities, Raspberry PI provides the computing power.

All these features and possibilities have contributed to their popularity among people involved in technology as well as computing aficionados. That is the case of the Internet of Things, ... smart citizen ...
