...
These requirements have been obtained by means of some meetings with the CREAF researcher in charge of the project. Even though the terms \textit{sensor} and \textit{simulator} may be used interchangeably as explained above, we use the former in the requirements below to keep consistency across the whole MS Thesis.
