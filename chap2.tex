...
Even though the terms \textit{sensor} and \textit{simulator} may be used interchangeably as explained above, we use the former in the requirements below to keep consistency across the whole MS Thesis.
...
\addfield{Rationale:}{The users must be able to browse the location of the observations on a map in real time.}
\end{usecase}
