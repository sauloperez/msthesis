...
\begin{usecase}
	...
	\addscenario{Main Success Scenario:}{
		...
		\item Once loaded, the web application establishes a stream connection against the web server
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{insert_sensor_seq}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{insert_observation_seq}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{browse_data_seq}
